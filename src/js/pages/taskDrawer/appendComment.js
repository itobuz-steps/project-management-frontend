...
export function appendCommentToContainer(comment, container) {
  ...
  <div id="CommentInformation" class="flex flex-col gap-1 md:gap-2 flex-1">
    ...
    <div class="flex items-center gap-2">
      ...
      alt="Avatar"
      class="w-7 h-7 rounded-full border border-primary-300"
      />
    ...
    <div class="edit-controls hidden">
      <textarea class="edit-input w-full border border-gray-200 rounded-md p-2 min-h-20 outline-none" rows="1">${
        comment.message
      }</textarea>
      <button class="save-btn btn-primary mt-0! py-1! w-full">Save</button>
    </div>
  </div>
  `;
