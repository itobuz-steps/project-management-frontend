...
export async function showTaskDrawer(taskId) {
  ...
  console.log('attachments is ', task.attachments);
  ...
  function renderAttachments(task) {
    ...
    task.attachments.forEach((fileName) => {
      ...
      attachmentItem.className =
        'flex items-center gap-2 px-3 py-2 border rounded-lg hover:bg-gray-100 transition text-[#03045e] text-sm';

      attachmentItem.innerHTML = `
      <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#03045e]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
